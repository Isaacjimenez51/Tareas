...
int main(){
	...
	"\t3.Meter Elemento en Pocicion.\n"<<
	"\t4.Eliminar Elemnto.\n"<<
	"\t5.Exterminar Repetidos.\n"<<
	"\t6.Desaparecer Lista.\n"<<
	"\t7.Ordenar por Metodo Burbuja.\n"<<
	"\t8.Imprimir la Lista.\n"<<
	"\t9.Modificar Elemento.\n"<<
	"\t10.Salir.\n";
	cout<<"Eliga una opcion del 1 al 10: ";
	cin>>opc;
	...
	switch(opc){
		...
		case 5:
			...
			cout<<"Los elemetos repetidos han sido borradas";
			pausa();
			break;
		case 6:
			eliminarLista(lista);
			cout<<"La lista se elimino con exito";
			pausa();
			break;
		case 7:
			burbuja(lista);
			cout<<"La lista se ordeno correctamente";
			pausa();
			break;
		case 8:
			cout<<"Lista doble: ";
